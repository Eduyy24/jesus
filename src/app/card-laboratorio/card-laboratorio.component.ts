...
@Component({
  selector: 'app-card-laboratorio',
  templateUrl: './card-laboratorio.component.html',
  styleUrls: ['./card-laboratorio.component.css']
})
export class CardLaboratorioComponent implements OnInit {
